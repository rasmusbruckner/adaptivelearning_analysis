...
fig_3_ef_desc = pd.DataFrame()
fig_3_ef_stat = pd.DataFrame()

# Median parameter estimates
fig_3_ef_desc['median_alpha'] = round(median_alpha, 3)
fig_3_ef_desc['median_bb'] = round(median_bb, 3)

# First quartile
fig_3_ef_desc['q1_alpha'] = round(q1_alpha, 3)
fig_3_ef_desc['q1_bb'] = round(q1_bb, 3)

# Third quartile
fig_3_ef_desc['q3_alpha'] = round(q3_alpha, 3)
fig_3_ef_desc['q3_bb'] = round(q3_bb, 3)
fig_3_ef_desc.index.name = 'age_group'
fig_3_ef_desc = fig_3_ef_desc.rename({1: 'ch', 2: 'ad', 3: 'ya', 4: 'oa'}, axis='index')

# P-values and test statistics
fig_3_ef_stat['p_alpha'] = p_alpha
fig_3_ef_stat['stat_alpha'] = stat_alpha
fig_3_ef_stat['p_bb'] = p_bb
fig_3_ef_stat['stat_bb'] = stat_bb
fig_3_ef_stat.index.name = 'test'
fig_3_ef_stat = fig_3_ef_stat.rename({0: 'kw', 1: 'ch_ad', 2: 'ch_ya', 3: 'ch_oa', 4: 'ad_ya', 5: 'ad_oa', 6: 'ya_oa'},
                                     axis='index')

# Save statistics for Latex manuscript
fig_3_ef_desc.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_ef_desc.csv')
fig_3_ef_stat.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_ef_stat.csv')
...
# Compute differences
fig_3_c_cond_diff, fig_3_c_desc, fig_3_c_stat, fig_3_c_zero_stat = get_cond_diff(df_noPush, df_push, voi)
fig_3_c_desc.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_c_desc.csv')
fig_3_c_stat.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_c_stat.csv')
...
voi = 1
fig_3_d_cond_diff, fig_3_d_desc, fig_3_d_stat, fig_3_d_zero_stat = get_cond_diff(df_noPush, df_push, voi)
fig_3_d_desc.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_d_desc.csv')
fig_3_d_stat.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_d_stat.csv')
...
# Create data frames to save statistics for Latex manuscript
fig_3_g_desc = pd.DataFrame()
fig_3_g_stat = pd.DataFrame()

# Median parameter estimates
fig_3_g_desc['median_omikron_0'] = round(median_omikron_0, 3)
fig_3_g_desc['median_omikron_1'] = round(median_omikron_1, 3)
fig_3_g_desc['median_b_0'] = round(median_b_0, 3)
fig_3_g_desc['median_b_1'] = round(median_b_1, 3)
fig_3_g_desc['median_u'] = round(median_u, 3)
fig_3_g_desc['median_s'] = round(median_s, 3)
fig_3_g_desc['median_h'] = round(median_h, 3)
fig_3_g_desc['median_sigma_H'] = round(median_sigma_H, 3)
fig_3_g_desc['median_d'] = round(median_d, 3)

# First quartile
fig_3_g_desc['q1_omikron_0'] = round(q1_omikron_0, 3)
fig_3_g_desc['q1_omikron_1'] = round(q1_omikron_1, 3)
fig_3_g_desc['q1_b_0'] = round(q1_b_0, 3)
fig_3_g_desc['q1_b_1'] = round(q1_b_1, 3)
fig_3_g_desc['q1_u'] = round(q1_u, 3)
fig_3_g_desc['q1_s'] = round(q1_s, 3)
fig_3_g_desc['q1_h'] = round(q1_h, 3)
fig_3_g_desc['q1_sigma_H'] = round(q1_sigma_H, 3)
fig_3_g_desc['q1_d'] = round(q1_d, 3)

# Third quartile
fig_3_g_desc['q3_omikron_0'] = round(q3_omikron_0, 3)
fig_3_g_desc['q3_omikron_1'] = round(q3_omikron_1, 3)
fig_3_g_desc['q3_b_0'] = round(q3_b_0, 3)
fig_3_g_desc['q3_b_1'] = round(q3_b_1, 3)
fig_3_g_desc['q3_u'] = round(q3_u, 3)
fig_3_g_desc['q3_s'] = round(q3_s, 3)
fig_3_g_desc['q3_h'] = round(q3_h, 3)
fig_3_g_desc['q3_sigma_H'] = round(q3_sigma_H, 3)
fig_3_g_desc['q3_d'] = round(q3_d, 3)
fig_3_g_desc.index.name = 'age_group'
fig_3_g_desc = fig_3_g_desc.rename({1: 'ch', 2: 'ad', 3: 'ya', 4: 'oa'}, axis='index')

# P-values and test statistics
fig_3_g_stat['p_omikron_0'] = p_omikron_0
fig_3_g_stat['stat_omikron_0'] = stat_omikron_0
fig_3_g_stat['p_omikron_1'] = p_omikron_1
fig_3_g_stat['stat_omikron_1'] = stat_omikron_1
fig_3_g_stat['p_b_0'] = p_b_0
fig_3_g_stat['stat_b_0'] = stat_b_0
fig_3_g_stat['p_b_1'] = p_b_1
fig_3_g_stat['stat_b_1'] = stat_b_1
fig_3_g_stat['p_u'] = p_u
fig_3_g_stat['stat_u'] = stat_u
fig_3_g_stat['p_s'] = p_s
fig_3_g_stat['stat_s'] = stat_s
fig_3_g_stat['p_h'] = p_h
fig_3_g_stat['stat_h'] = stat_h
fig_3_g_stat['p_sigma_H'] = p_sigma_H
fig_3_g_stat['stat_sigma_H'] = stat_sigma_H
fig_3_g_stat['p_d'] = p_d
fig_3_g_stat['stat_d'] = stat_d
fig_3_g_stat.index.name = 'test'
fig_3_g_stat = fig_3_g_stat.rename({0: 'kw', 1: 'ch_ad', 2: 'ch_ya', 3: 'ch_oa', 4: 'ad_ya', 5: 'ad_oa', 6: 'ya_oa'},
                                   axis='index')

# Save statistics for Latex manuscript
fig_3_g_desc.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_g_desc.csv')
fig_3_g_stat.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_3_g_stat.csv')
...
f.add_subplot(ax_11)
ax_11 = swarm_boxplot(ax_11, fig_3_c_cond_diff, 'pers', 'Perseveration-\nprobability difference', 2)

# Estimation errors
ax_12 = plt.Subplot(f, gs02[0, 1])
f.add_subplot(ax_12)
swarm_boxplot(ax_12, fig_3_d_cond_diff, 'e_t', 'Estimation-\nerror difference', 2)
...
ax_20.set_ylabel('Belief-updating bias\n(regression)')
...
ax_21.set_ylabel('Belief-updating bias\n(Bayesian model)')
...
ax_22.set_ylabel('Belief-updating bias\n(Bayesian model)')
...
label_subplots(f, texts, x_offset=0.09, y_offset=0.01)
