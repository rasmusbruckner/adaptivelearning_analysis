""" Figure S4: Mixture-model illustration
...
ax_00.plot(pe, np.zeros(80), color="#0F4C75")
...
ax_01.plot(np.arange(80), pers_prob, color="#0F4C75")
ax_01.plot(np.arange(80), up_prob, color="k")
