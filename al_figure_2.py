...
fig_2_desc = pd.DataFrame()
fig_2_stat = pd.DataFrame()

# Median parameter estimates
fig_2_desc['median_omikron_0'] = round(median_omikron_0, 3)
fig_2_desc['median_omikron_1'] = round(median_omikron_1, 3)
fig_2_desc['median_b_0'] = round(median_b_0, 3)
fig_2_desc['median_b_1'] = round(median_b_1, 3)
fig_2_desc['median_u'] = round(median_u, 3)
fig_2_desc['median_s'] = round(median_s, 3)
fig_2_desc['median_h'] = round(median_h, 3)
fig_2_desc['median_q'] = round(median_q, 3)
fig_2_desc['median_sigma_H'] = round(median_sigma_H, 3)

# First quartile
fig_2_desc['q1_omikron_0'] = round(q1_omikron_0, 3)
fig_2_desc['q1_omikron_1'] = round(q1_omikron_1, 3)
fig_2_desc['q1_b_0'] = round(q1_b_0, 3)
fig_2_desc['q1_b_1'] = round(q1_b_1, 3)
fig_2_desc['q1_u'] = round(q1_u, 3)
fig_2_desc['q1_s'] = round(q1_s, 3)
fig_2_desc['q1_h'] = round(q1_h, 3)
fig_2_desc['q1_q'] = round(q1_q, 3)
fig_2_desc['q1_sigma_H'] = round(q1_sigma_H, 3)

# Third quartile
fig_2_desc['q3_omikron_0'] = round(q3_omikron_0, 3)
fig_2_desc['q3_omikron_1'] = round(q3_omikron_1, 3)
fig_2_desc['q3_b_0'] = round(q3_b_0, 3)
fig_2_desc['q3_b_1'] = round(q3_b_1, 3)
fig_2_desc['q3_u'] = round(q3_u, 3)
fig_2_desc['q3_s'] = round(q3_s, 3)
fig_2_desc['q3_h'] = round(q3_h, 3)
fig_2_desc['q3_q'] = round(q3_q, 3)
fig_2_desc['q3_sigma_H'] = round(q3_sigma_H, 3)

# Rename index and groups
fig_2_desc.index.name = 'age_group'
fig_2_desc = fig_2_desc.rename({1: 'ch', 2: 'ad', 3: 'ya', 4: 'oa'}, axis='index')

# P-values and test statistics
fig_2_stat['p_omikron_0'] = p_omikron_0
fig_2_stat['stat_omikron_0'] = stat_omikron_0
fig_2_stat['p_omikron_1'] = p_omikron_1
fig_2_stat['stat_omikron_1'] = stat_omikron_1
fig_2_stat['p_b_0'] = p_b_0
fig_2_stat['stat_b_0'] = stat_b_0
fig_2_stat['p_b_1'] = p_b_1
fig_2_stat['stat_b_1'] = stat_b_1
fig_2_stat['p_u'] = p_u
fig_2_stat['stat_u'] = stat_u
fig_2_stat['p_s'] = p_s
fig_2_stat['stat_s'] = stat_s
fig_2_stat['p_h'] = p_h
fig_2_stat['stat_h'] = stat_h
fig_2_stat['p_q'] = p_q
fig_2_stat['stat_q'] = stat_q
fig_2_stat['p_sigma_H'] = p_sigma_H
fig_2_stat['stat_sigma_H'] = stat_sigma_H

# Rename index and tests
fig_2_stat.index.name = 'test'
fig_2_stat = fig_2_stat.rename({0: 'kw', 1: 'ch_ad', 2: 'ch_ya', 3: 'ch_oa', 4: 'ad_ya', 5: 'ad_oa', 6: 'ya_oa'},
                               axis='index')
# Save statistics for Latex manuscript
fig_2_desc.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_2_desc.csv')
fig_2_stat.to_csv('~/Dropbox/Apps/Overleaf/al_manuscript/al_dataframes/fig_2_stat.csv')
